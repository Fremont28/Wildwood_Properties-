...
#i. do properties longer on market, sell less than asking price?
def long_props(x):
    if x>=365000:
        return 3
...
#resample time series (differente time series) 
#i. weekly 
